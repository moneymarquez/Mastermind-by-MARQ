...
const groupLabel: CSSProperties = { fontSize: 11, fontWeight: 700, color: '#565b64', textTransform: 'uppercase', letterSpacing: 0.4, marginTop: 22, marginBottom: 10 };
const fieldLabel: CSSProperties = { fontSize: 12, color: '#8A8F98', marginBottom: 5 };
const ghostBtn: CSSProperties = { fontSize: 12, color: '#8A8F98', cursor: 'pointer' };
const addBtn: CSSProperties = { display: 'inline-block', marginTop: 10, padding: '7px 14px', borderRadius: 999, border: '1px solid #22262B', color: '#F5F6F7', fontSize: 12, cursor: 'pointer' };
        ...
        return (
          <div key={t.key}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
              {rows.map((row, i) => (
                <div key={i} style={{ border: '1px solid #22262B', borderRadius: 10, padding: 12, display: 'flex', flexDirection: 'column', gap: 8 }}>
                  {t.columns.map((c) => (
                    <input
  ...
  return (
    <div>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
        {tiers.map((tier, i) => (
          <div key={i} style={{ border: '1px solid #22262B', borderRadius: 10, padding: 14, display: 'flex', flexDirection: 'column', gap: 8 }}>
