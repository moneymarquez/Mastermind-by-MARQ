  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--bg)', padding: '48px 24px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <div style={{ width: '100%', maxWidth: 420, textAlign: 'center' }}>
        <div style={{ fontSize: 26, fontWeight: 700, color: 'var(--text)', marginBottom: 8 }}>Name your AI</div>
        <div style={{ fontSize: 13.5, color: 'var(--text-secondary)', marginBottom: 28, lineHeight: 1.6 }}>
        ...
        <button
          ...
          style={{
            width: '100%', marginTop: 20, padding: '13px 18px', borderRadius: 999, border: 'none', background: 'var(--text)', color: 'var(--bg)',
