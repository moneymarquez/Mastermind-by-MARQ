...
export const MODULE_REGISTRY: ModuleDef[] = [
  ...
  { key: 'support-inbox', label: 'Support Inbox', category: 'Scaling', description: 'Mail sent to any @mastermindsbymarq.com address, AI-categorized with a drafted reply for review.', icon: 'ph-address-book', routes: ['support-inbox'], requiresAI: true, ownerOnly: true },
  ...
  { key: 'client-crm', label: 'Client CRM', category: 'Scaling', description: 'Discovery → analysis → pricing → Stripe invoice → active client, in one pipeline.', icon: 'ph-users', routes: ['client-crm'], requiresAI: true, ownerOnly: true },
