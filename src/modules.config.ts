...
export const MODULE_REGISTRY: ModuleDef[] = [
  ...
  { key: 'brain', label: 'Brain', category: 'Personal', description: 'A four-minute assessment of how you sell and follow through, a daily check-in on the calling hour, and the patterns in your own data.', icon: 'ph-brain', routes: ['brain'], requiresAI: false },
